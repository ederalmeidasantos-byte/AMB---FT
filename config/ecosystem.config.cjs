  ...
  apps: [
    {
      ...
      instances: 1,
      exec_mode: 'fork',
      node_args: '--max-old-space-size=4096', // Aumentar limite de heap para 4GB
      env: {
      ...
      merge_logs: true,
      max_memory_restart: '3584M', // Limite do PM2 (3.5GB em MB - menor que heap do Node para dar margem)
      restart_delay: 4000,
      max_restarts: 10,
      min_uptime: '10s',
      watch: false,
